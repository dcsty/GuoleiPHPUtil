...
class RsaUtil
{
     ...
     * @return string
     */
    public static function sign($data, $private_key, $signature_alg = 'sha256WithRSAEncryption')
    {
        $res = openssl_get_privatekey($private_key);
        $sign = null;
     ...
     * @return type
     */
    public static function verify($data, $sign, $pubilc_key, $signature_alg = 'sha256WithRSAEncryption')
    {
